...
int main()
{ 
    //vector<vector<int>> all_lists = {{2, 5, 9, 21},
	//					            {-1, 0, 2},
	//					            {-10, 81, 121},
	//					            {4, 6, 12, 20, 150}};
                                    // -10, -1, 0, 2, 2, 4, 5, 6, 9, 12, 20, 21, 81,	121,	150
    //vector<vector<int>> all_lists = {{10, 17, 18, 21, 29},
	//					            {-3, 0, 3, 7, 8, 11},
	//					            {81, 88, 121, 131},
	//    				            {9, 11, 12, 19, 29}};
                                    //-3, 0, 3, 7, 8, 9, 10, 11, 11, 12, 17, 18, 19, 21, 29, 29, 81, 88, 121, 131
    vector<vector<int>> all_lists = {{-4, -2, 0, 2, 7},
						            {4, 6, 12, 14},
						            {10, 15, 25},
	    				            {5, 6, 10, 20, 24}};
    ...
    {
        int colNum = all_lists[rowNum].size(); // get the number of elems in the row
